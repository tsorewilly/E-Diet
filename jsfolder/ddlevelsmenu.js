...
downarrowpointer: ["images/down.gif", 5,5], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: ["images/right.gif", 5,5], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
hideinterval: 300, //delay in milliseconds before entire menu disappears onmouseout.
revealanimate: [true, 20], //enable sliding animation when revealing sub menus? [Bool, int_steps] (steps: 5-100, where lower=faster)
